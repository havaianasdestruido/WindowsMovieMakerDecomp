...
// Self-contained: searches for DLL relative to test binary location
...
// Opt-in State / Query
typedef DWORD (__stdcall *GetOptInStateFunc)();
...
// ============================================================
// Test: probe a single function pointer
// ============================================================
...
// ============================================================
// Main - probe + selective safe calls
// ============================================================
int main(int argc, char** argv) {
    ...
    // === Safe live calls (query-only + lifecycle) ===
    printf("\n========================================\n");
    printf("  Safe Live Calls\n");
    printf("========================================\n");
